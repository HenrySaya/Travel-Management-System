...
public class Dashboard extends JFrame implements ActionListener{
    ...
    String username;
    JButton addPersonalDetails, viewPersonalDetails, updatePersonalDetails, checkpackages, bookpackage, bookhotel, deletePersonalDetails;
    JButton viewpackage, viewhotels, destinations, viewbookedhotel, payments;
  ...
  //      setBounds(0, 0, 1600, 1000);
        ...
        addPersonalDetails.setBorder(null);
        ...
        updatePersonalDetails.setBorder(null);
        ...
        viewPersonalDetails.setBorder(null);
        ...
        deletePersonalDetails.setBorder(null);
        ...
        bookpackage.setBackground(new Color(0, 0, 0));
        ...
        calculators.setBackground(new Color(0, 0, 0));
        calculators.setForeground(Color.WHITE);
        calculators.setFont(new Font("Tahoma", Font.BOLD, 15));
        ...
        notepad.setBackground(new Color(0, 0, 0));
