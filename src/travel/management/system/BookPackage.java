...
public class BookPackage extends JFrame implements ActionListener{
    ...
    BookPackage(String username) {
        ...
        add(labelprice);
         ...
         try {
            Conn conn = new Conn();
            //String query = "select * customer where username = '"+username+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkprice) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Pacckage booked successfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
