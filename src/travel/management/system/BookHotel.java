...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username) {
        ...
        lblphone.setBounds(40, 390, 350, 20);
        add(lblphone);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkprice) {
            try {
                Conn d = new Conn();
                ResultSet rs = d.s.executeQuery("select * from hotel where name = '"+chotel.getSelectedItem()+"'");
                while (rs.next()) {
            ...
            try {
                Conn cn = new Conn();
                cn.s.executeUpdate("insert into bookhotel values('"+labelusername.getText()+"', '"+chotel.getSelectedItem()+"', '"+tfpersons.getText()+"', '"+tfdays.getText()+"', '"+cac.getSelectedItem()+"', '"+cfood.getSelectedItem()+"', '"+labelid.getText()+"', '"+labelnumber.getText()+"', '"+labelphone.getText()+"', '"+labelprice.getText()+"')");
